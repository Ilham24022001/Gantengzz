...
cd /usr/bin
wget https://raw.githubusercontent.com/Ilham24022001/gantengzz/main/Bot/bot.zip
unzip bot.zip
mv bot/* /usr/bin
chmod +x /usr/bin/*
rm -rf bot.zip
clear
wget https://raw.githubusercontent.com/Ilham24022001/gantengzz/main/Bot/kyt.zip
unzip kyt.zip
